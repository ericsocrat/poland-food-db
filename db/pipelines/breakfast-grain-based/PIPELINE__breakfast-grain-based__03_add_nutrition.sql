...
from (
  values
    ...
    ('One Day More', 'Musli z truskawkami, czerwonymi porzeczkami i czekoladą mleczna', 400.0, 8.7, 3.1, 0, 65.2, 10.4, 5.8, 11.7, 0.2),
    ...
    ('One Day More', 'Musli z malinami i jeżynami', 350.0, 2.2, 0.4, 0, 68.0, 8.4, 10.7, 9.1, 0.0),
    ...
    ('Sante', 'Sante Crunchy Crispy Muesli Banana With Chocolate 350G', 423.0, 15.0, 6.4, 0, 67.0, 26.0, 6.6, 7.7, 0.3),
    ...
    ('One Day More', 'Musli Keto Choco', 598.0, 48.5, 6.8, 0, 11.0, 5.6, 10.1, 25.5, 0.1),
    ...
    -- ── Batch 2 — breakfast (new) ───────────────────────────────────────────────────
    ('One Day More', 'Meusli Fruits et Chocolat Blanc', 387, 8.4, 2.9, 0, 61.4, 11.2, 9.6, 10, 0.02)  -- OFF (protein corrected from OCR error)
