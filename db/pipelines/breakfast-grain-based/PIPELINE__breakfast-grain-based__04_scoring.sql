...
from (
  values
    ...
    ('One Day More', 'Musli z truskawkami, czerwonymi porzeczkami i czekoladą mleczna', 'C'),
    ...
    ('One Day More', 'Musli z malinami i jeżynami', 'A'),
    ...
    ('Sante', 'Sante Crunchy Crispy Muesli Banana With Chocolate 350G', 'D'),
    ...
    ('Bell''s', 'Crunchy', 'C'),
    ('One Day More', 'Musli Keto Choco', 'C'),
...
from (
  values
    ...
    ('One Day More', 'Musli z truskawkami, czerwonymi porzeczkami i czekoladą mleczna', '3'),
    ...
    ('One Day More', 'Musli z malinami i jeżynami', '3'),
    ...
    ('Sante', 'Sante Crunchy Crispy Muesli Banana With Chocolate 350G', '4'),
    ...
    ('Bell''s', 'Crunchy', '4'),
    ('One Day More', 'Musli Keto Choco', '4'),
