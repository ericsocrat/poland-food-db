...
values
  ...
  ('PL', 'Melvit', 'Grocery', 'Breakfast & Grain-Based', 'CRISPY PIECZYWO CHRUPKIE z serem i cebulką', 'not-applicable', 'Lidl,rossman,mlekovita', 'none', '5906827017823'),
  ...
  ('PL', 'Kupiec', 'Grocery', 'Breakfast & Grain-Based', 'Coś na ząb owsianka z jabłkiem i bananem', 'not-applicable', 'Megasam Żoliborski,Społem', 'none', '5906747171414'),
  ...
  ('PL', 'Inna Bajka', 'Grocery', 'Breakfast & Grain-Based', 'Owsianka Mango i Jagody Goji', 'not-applicable', 'Żabka,Carrefour', 'none', '5902860470014'),
  ...
  ('PL', 'Sante', 'Grocery', 'Breakfast & Grain-Based', 'Granola chocolate / pieces of chocolate', 'not-applicable', 'Green,Yerevan City', 'none', '5900617002983'),
