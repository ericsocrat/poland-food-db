...
where ean in ('5900617015723', '5900617013064', '5900617034809', '5060088706534', '3560071504090', '7622300784751', '3800205871255')
  and ean is not null;
...
where country = 'PL' and category = 'Snacks'
  and is_deprecated is not true
  and product_name not in ('Crunchy Cranberry & Raspberry - Santé', 'Sante Baton Proteinowy Go On Kakaowy', 'Vitamin coconut bar', 'Blueberry Muffin Myrtilles', 'Toast crock'' céréales complètes', 'Cake & Chock', 'Bruschette Chips Pizza Flavour');
