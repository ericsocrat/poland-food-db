...
values
  ...
  ('PL', 'Lorenz', 'Grocery', 'Chips', 'Crunchips Pieczone Żeberka', null, 'Żabka,Stokrotka', 'none', '5905187114760'),
  ...
  ('PL', 'Lay''s', 'Grocery', 'Chips', 'Lays solone', null, 'EKO Market', 'none', '5900259127600'),
  ...
  ('PL', 'Cheetos', 'Grocery', 'Chips', 'Cheetos Flamin Hot', null, 'Malina', 'none', '5900259135360'),
  ('PL', 'Lay''s', 'Grocery', 'Chips', 'Cheetos Cheese', null, null, 'none', '5900259029041'),
  ('PL', 'Crunchips', 'Grocery', 'Chips', 'Potato crisps with paprika flavour.', null, 'Morrisons', 'none', '5905187114746'),
