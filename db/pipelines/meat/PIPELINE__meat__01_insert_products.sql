...
values
  ...
  ('PL', 'Tarczyński', 'Grocery', 'Meat', 'Naturalne Parówki 100% z szynki', 'not-applicable', 'Stokrotka,Żabka', 'none', '5908230526602'),
  ...
  ('PL', 'Morliny', 'Grocery', 'Meat', 'Szynka konserwowa z galaretką', 'not-applicable', 'Biedronka,Aldi', 'none', '5900244025621'),
  ('PL', 'Stoczek', 'Grocery', 'Meat', 'Kiełbasa z weka', 'not-applicable', 'Auchan', 'none', '5901002006524'),
  ('PL', 'Drobimex', 'Grocery', 'Meat', 'Szynka delikatesowa z kurcząt', 'not-applicable', 'Biedronka,Żabka', 'none', '5900196004026'),
  ...
  ('PL', 'Kraina Wędlin', 'Grocery', 'Meat', 'Szynka Zawędzana', 'not-applicable', 'Biedronka', 'none', '5900562460111'),
  ...
  ('PL', 'tarczyński', 'Grocery', 'Meat', 'Kabanosy wieprzowe', 'not-applicable', 'Lidl,Biedonka,Żabka', 'none', '5908230521485'),
  ('PL', 'Morliny', 'Grocery', 'Meat', 'Berlinki classic', 'not-applicable', 'Biedronka', 'none', '5900567009681'),
  ('PL', 'Animex Foods', 'Grocery', 'Meat', 'Berlinki Kurczak', 'not-applicable', 'Dino,Penny', 'none', '5901664003749'),
  ...
  ('PL', 'Drosed', 'Grocery', 'Meat', 'Podlaski pasztet drobiowy', 'not-applicable', 'Auchan,Polnische Spezialitäten by Ewa und & Jarek', 'none', '5901204000788'),
  ...
  ('PL', 'Tarczynski', 'Grocery', 'Meat', 'Krakauer Wurst (polnische Brühwurst)', 'not-applicable', 'Kaufland,Picnic,Tegut,Rewe', 'none', '5908230515804'),
