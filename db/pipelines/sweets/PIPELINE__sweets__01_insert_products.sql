...
values
  ...
  ('PL', 'Lindt Excellence', 'Grocery', 'Sweets', 'Excellence 85% Cacao Rich Dark', 'not-applicable', 'Kaufland', 'none', '3046920028363'),
  ('PL', 'Milka', 'Grocery', 'Sweets', 'Chocolat au lait', 'not-applicable', 'Auchan', 'none', '3045140105502'),
  ('PL', 'Toblerone', 'Grocery', 'Sweets', 'Milk Chocolate with Honey and Almond Nougat', 'not-applicable', 'Lidl', 'none', '7614500010013'),
  ('PL', 'Storck', 'Grocery', 'Sweets', 'Merci Finest Selection Assorted Chocolates', 'not-applicable', 'Tesco', 'none', '4014400901191'),
  ...
  ('PL', 'Lindt', 'Grocery', 'Sweets', 'Lindt Excellence Dark Orange Intense', 'not-applicable', 'Tesco', 'none', '3046920028370'),
  ('PL', 'Fin Carré', 'Grocery', 'Sweets', 'Weiße Schokolade', 'not-applicable', 'Lidl', 'none', '20368197'),
  ('PL', 'Milka', 'Grocery', 'Sweets', 'Milka chocolate Hazelnuts', 'not-applicable', 'Żabka', 'none', '4025700001023'),
  ('PL', 'Fin Carré', 'Grocery', 'Sweets', 'Extra Dark 85% Cocoa', 'not-applicable', 'Lidl', 'none', '4056489366461'),
  ('PL', 'Ritter SPORT', 'Grocery', 'Sweets', 'Marzipan Dark Chocolate With Marzipan', 'not-applicable', 'Lidl', 'none', '4000417025005'),
  ('PL', 'Milka', 'Grocery', 'Sweets', 'Happy Cow', 'not-applicable', 'Lidl', 'none', '7622400005190'),
  ('PL', 'Heidi', 'Grocery', 'Sweets', 'Dark Intense', 'not-applicable', 'Auchan', 'none', '5941021001261'),
  ('PL', 'Schogetten', 'Grocery', 'Sweets', 'Schogetten alpine milk chocolate', 'not-applicable', 'Lidl', 'none', '4000607850004'),
  ('PL', 'Milka', 'Grocery', 'Sweets', 'Milka Mmmax Oreo', 'not-applicable', 'Żabka', 'none', '7622210240200'),
  ('PL', 'Milka', 'Grocery', 'Sweets', 'Schokolade Joghurt', 'not-applicable', 'Żabka', 'none', '4025700001450'),
