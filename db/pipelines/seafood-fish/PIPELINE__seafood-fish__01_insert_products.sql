...
values
  ...
  ('PL', 'Contimax', 'Grocery', 'Seafood & Fish', 'Wiejskie filety śledziowe marynowane z cebulą', 'marinated', null, 'none', '5901576044724'),
  ...
  ('PL', 'Marinero', 'Grocery', 'Seafood & Fish', 'Łosoś łagodny', 'not-applicable', null, 'none', '5903475440133'),
  ...
  ('PL', 'Koryb', 'Grocery', 'Seafood & Fish', 'Łosoś atlantycki', 'not-applicable', null, 'none', '5902020533115'),
