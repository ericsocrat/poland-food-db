...
values
  ('PL', 'Mlekpol', 'Grocery', 'Dairy', 'Łaciate 3,2%', 'not-applicable', 'Carrefour,Delikatesy Centrum', 'none', '5900820000011'),
  ...
  ('PL', 'Piatnica', 'Grocery', 'Dairy', 'Serek Wiejski wysokobiałkowy', 'not-applicable', 'Lidl,biedronka,żabka,Carrefour,Stokrotka,Auchan', 'none', '5900531007019'),
  ('PL', 'Łaciate', 'Grocery', 'Dairy', 'Łaciaty serek śmietankowy', 'not-applicable', 'Stokrotka,Żabka', 'none', '5900820011468'),
  ('PL', 'Piątnica', 'Grocery', 'Dairy', 'Twój Smak Serek śmietankowy', 'not-applicable', 'Stokrotka,Żabka', 'none', '5900531000508'),
  ('PL', 'Łaciate', 'Grocery', 'Dairy', 'Masło extra Łaciate', 'not-applicable', 'Biedronka,Żabka,Stokrotka', 'none', '5900820000257'),
  ...
  ('PL', 'Mlekovita', 'Grocery', 'Dairy', 'Mleko Polskie SPOŻYWCZE', 'not-applicable', 'Mila,Alta', 'none', '5900512850023'),
  ('PL', 'PIĄTNICA', 'Grocery', 'Dairy', 'SEREK WIEJSKI', 'not-applicable', 'Auchan,Żabka,Biedronka', 'none', '5900531000010'),
