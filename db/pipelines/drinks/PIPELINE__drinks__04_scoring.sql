...
from (
  values
    ...
    ('Oshee', 'OSHEE Zero', 'C'),
    ('Żywiec Zdrój', 'Zywiec Woda Srednio Gazowana', 'B'),
    ...
    ('Herbapol', 'Malina', 'B'),
    -- batch 2
    ('Kubuś', '100% jabłko', 'D')  -- high sugars in juice
...
from (
  values
    ...
    ('Oshee', 'OSHEE Zero', '4'),
    ('Żywiec Zdrój', 'Zywiec Woda Srednio Gazowana', '1'),
    ...
    ('Herbapol', 'Malina', '4'),
    -- batch 2
    ('Kubuś', '100% jabłko', '1')  -- 100% juice, no additives
