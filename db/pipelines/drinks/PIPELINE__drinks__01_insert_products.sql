...
values
  ...
  ('PL', 'Kubuś', 'Grocery', 'Drinks', '100% jabłko', 'not-applicable', null, 'none', '5901067401548'),
  ...
  ('PL', 'Go Vege', 'Grocery', 'Drinks', 'Ryż', 'not-applicable', null, 'none', '5900001421307'),
  ...
  ('PL', 'Żywiec Zdrój', 'Grocery', 'Drinks', 'Zywiec Woda Srednio Gazowana', 'not-applicable', null, 'none', '5900541000499'),
