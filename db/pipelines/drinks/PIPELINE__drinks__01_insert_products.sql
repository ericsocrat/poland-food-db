...
values
  ...
  ('PL', 'Tymbark', 'Grocery', 'Drinks', 'Tymbark Jablko Mięta 0.5', 'not-applicable', 'Noz', 'none', '5900334000255'),
  ('PL', 'Żywiec Zdrój', 'Grocery', 'Drinks', 'Niegazowany', 'not-applicable', 'Biedronka,Żabka,Lidl', 'none', '5900541000000'),
  ...
  ('PL', 'Tymbark', 'Grocery', 'Drinks', 'Tymbark 100% jablko', 'not-applicable', 'Dino,carrefour', 'none', '5900334005939'),
  ('PL', 'Riviva', 'Grocery', 'Drinks', 'Sok 100% multiwitamina', 'not-applicable', 'KIWI,Biedronka,Kaufland', 'none', '5901886039427'),
  ...
  ('PL', 'Pepsi', 'Grocery', 'Drinks', 'Pepsi Zero', 'not-applicable', 'Billa,Billa Plus,Lidl', 'none', '5900497302005'),
  ...
  ('PL', 'Tiger', 'Grocery', 'Drinks', 'Tiger placebo classic', 'not-applicable', 'Żapka,Biedronka', 'none', '5900334020468'),
  ...
  ('PL', 'oshee', 'Grocery', 'Drinks', 'Oshee Multifruit', 'not-applicable', 'YES! Stores', 'none', '5908260251963'),
  ...
  ('PL', 'OSHEE', 'Grocery', 'Drinks', 'OSHEE Zero', 'not-applicable', 'Home Bargains', 'none', '5908260251574'),
