-- PIPELINE (NUTS-SEEDS): add servings
-- PIPELINE__nuts-seeds__02_add_servings.sql
-- Adds per-100g servings for nuts, seeds, and legumes (since labels are per 100g in EU).
