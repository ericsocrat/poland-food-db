...
values
  ...
  ('PL', 'Vita D''or', 'Grocery', 'Plant-Based & Alternatives', 'Rapsöl', 'not-applicable', 'Lidl', 'none', '20013578'),
  ('PL', 'Barilla', 'Grocery', 'Plant-Based & Alternatives', 'Pâtes spaghetti n°5 1kg', 'not-applicable', 'Magasins U,carrefour.fr', 'none', '8076800105056'),
  ...
  ('PL', 'GoVege', 'Grocery', 'Plant-Based & Alternatives', 'Tofu naturalne', 'not-applicable', 'Biedronka', 'none', '8586024420090'),
  ...
  ('PL', 'Dania Express', 'Grocery', 'Plant-Based & Alternatives', 'Lasaña', 'not-applicable', 'Pingo Doce', 'none', '5601009955176'),
