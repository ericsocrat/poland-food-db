...
from (
  values
    ...
    ('MegaRyba', 'Śledź w sosie pomidorowym', 'C'),
    ...
    ('MegaRyba', 'Filety z makreli w sosie pomidorowym', 'B'),
...
from (
  values
    ...
    ('MegaRyba', 'Śledź w sosie pomidorowym', '4'),
    ...
    ('MegaRyba', 'Filety z makreli w sosie pomidorowym', '4'),
