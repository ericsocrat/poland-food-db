...
values
  ...
  ('PL', 'MegaRyba', 'Grocery', 'Canned Goods', 'Śledź w sosie pomidorowym', 'not-applicable', 'Auchan', 'none', '5903895080025'),
  ...
  ('PL', 'MegaRyba', 'Grocery', 'Canned Goods', 'Filety z makreli w sosie pomidorowym', 'not-applicable', 'Dino', 'none', '5903895080056'),
