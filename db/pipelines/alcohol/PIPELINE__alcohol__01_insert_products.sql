...
where ean in ('5900014004245', '5901359074269', '5901359062013', '5903538900628', '5900490000182', '5900535015171', '5900014003569', '5901359144917', '4304493261709', '8712000900045', '1704314830009')
  and ean is not null;
...
where country = 'PL' and category = 'Alcohol'
  and is_deprecated is not true
  and product_name not in ('Harnaś jasne pełne', 'Polnische Bier (Dose)', 'Bier &quot;Tyskie Gronie&quot;', 'Łomża jasne', 'Lech Premium', 'Bière sans alcool', 'Pilsner 0.0%', 'Lech Free Lime Mint', 'Christkindl Glühwein', 'Heineken Beer', 'Glühwein');
