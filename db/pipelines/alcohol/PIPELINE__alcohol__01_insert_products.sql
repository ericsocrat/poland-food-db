...
values
  ('PL', 'Seth & Riley''s Garage Euphoriq', 'Grocery', 'Alcohol', 'Bezalkoholowy napój piwny o smaku jagód i marakui', null, 'Dino,Biedronka', 'none', '5900014005716'),
  ('PL', 'Magnetic', 'Grocery', 'Alcohol', 'Kakao o obniżonej zawartości tłuszczu ekstra ciemne', null, 'Biedronka', 'none', '5900910010906'),
  ('PL', 'Diamant', 'Grocery', 'Alcohol', 'Cukier Biały', null, 'Kaufland', 'none', '5907069000017'),
  ('PL', 'owolovo', 'Grocery', 'Alcohol', 'Truskawkowo Mus jabłkowo-truskawkowy', null, 'Lidl,Biedronka,Carrefour,Aldi,Selgros,Kaufland', 'none', '5901958612367'),
  ...
  ('PL', 'Żywiec', 'Grocery', 'Alcohol', 'Limonż 0%', null, null, 'none', '5900699106388'),
  ('PL', 'Polski Cukier', 'Grocery', 'Alcohol', 'Cukier biały', null, null, 'none', '5906340630011'),
  ...
  ('PL', 'Browar Fortuna', 'Grocery', 'Alcohol', 'Piwo Pilzner, dolnej fermentacji', null, 'Kaufland', 'none', '5902709615323'),
  ...
  ('PL', 'Książęce', 'Grocery', 'Alcohol', 'Książęce czerwony lager', null, null, 'none', '5901359014784'),
  ('PL', 'Lech', 'Grocery', 'Alcohol', 'Lech Premium', null, null, 'none', '5900490000182'),
  ('PL', 'Zatecky', 'Grocery', 'Alcohol', 'Zatecky 0%', null, null, 'none', '5900014005105'),
  ('PL', 'Kompania Piwowarska', 'Grocery', 'Alcohol', 'Lech free', null, null, 'none', '5901359122021'),
  ('PL', 'Łomża', 'Grocery', 'Alcohol', 'Radler 0,0%', null, null, 'none', '5900535019209'),
  ('PL', 'Łomża', 'Grocery', 'Alcohol', 'Bière sans alcool', null, 'IN''s', 'none', '5900535015171'),
  ('PL', 'Warka', 'Grocery', 'Alcohol', 'Piwo Warka Radler', null, null, 'none', '5900699106463'),
  ('PL', 'Nestlé', 'Grocery', 'Alcohol', 'Przyprawa Maggi', null, null, 'none', '5900085011180'),
  ('PL', 'Gryzzale', 'Grocery', 'Alcohol', 'polutry kabanos sausages', null, null, 'none', '5908230514647'),
  ...
  ('PL', 'Amber', 'Grocery', 'Alcohol', 'Amber IPA zero', null, null, 'none', '5906591002520'),
  ('PL', 'Unknown', 'Grocery', 'Alcohol', 'LECH FREE CITRUS SOUR', null, null, 'none', '5901359144689'),
  ('PL', 'Shroom', 'Grocery', 'Alcohol', 'Shroom power', null, null, 'none', '5905718983308'),
  ('PL', 'Christkindl', 'Grocery', 'Alcohol', 'Christkindl Glühwein', null, 'Lidl', 'none', '4304493261709'),
  ('PL', 'GO ACTIVE', 'Grocery', 'Alcohol', 'PUDDING PROTEINOWY SMAK CAFFE LATTE', null, 'Biedronka', 'none', '8595588201182'),
  ('PL', 'Heineken', 'Grocery', 'Alcohol', 'Heineken Beer', null, null, 'none', '8712000900045'),
  ('PL', 'Just 0.', 'Grocery', 'Alcohol', 'Just 0 White alcoholfree', null, 'Dealz', 'none', '4003301069086'),
  ('PL', 'Just 0.', 'Grocery', 'Alcohol', 'Just 0. Red', null, 'Dealz', 'none', '4003301069048'),
  ...
  ('PL', 'Choya', 'Grocery', 'Alcohol', 'Silver', null, null, 'none', '4905846960050'),
  ('PL', 'Carlo Rossi', 'Grocery', 'Alcohol', 'Vin carlo rossi', null, null, 'none', '0085000024683'),
  ('PL', 'Somersby', 'Grocery', 'Alcohol', 'Somersby Blueberry Flavoured Cider', null, null, 'none', '3856777584161')
