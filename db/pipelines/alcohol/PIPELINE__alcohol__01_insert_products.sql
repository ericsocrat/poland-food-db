...
values
  ('PL', 'Seth & Riley''s Garage Euphoriq', 'Grocery', 'Alcohol', 'Bezalkoholowy napój piwny o smaku jagód i marakui', 'not-applicable', 'Dino,Biedronka', 'none', '5900014005716'),
  ...
  ('PL', 'owolovo', 'Grocery', 'Alcohol', 'Truskawkowo Mus jabłkowo-truskawkowy', 'not-applicable', 'Lidl,Biedronka,Carrefour,Aldi,Selgros,Kaufland', 'none', '5901958612367'),
  ...
  ('PL', 'Tyskie', 'Grocery', 'Alcohol', 'Bier &quot;Tyskie Gronie&quot;', 'not-applicable', 'Real,Kaufland,Getränke Handel,Aral', 'none', '5901359062013'),
  ('PL', 'Velkopopovicky Kozel', 'Grocery', 'Alcohol', 'Polnische Bier (Dose)', 'not-applicable', 'Kaufland,Netto', 'none', '5901359074269'),
  ...
  ('PL', 'Łomża', 'Grocery', 'Alcohol', 'Bière sans alcool', 'not-applicable', 'IN''s', 'none', '5900535015171'),
