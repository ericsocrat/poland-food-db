...
values
  ...
  ('PL', 'Nestlé', 'Grocery', 'Cereals', 'Cini Minis Scorțișoară', 'not-applicable', 'Biedronka,Lidl', 'none', '5900020002730'),
  ...
  ('PL', 'sante', 'Grocery', 'Cereals', 'Sante gold granola', 'not-applicable', 'sultan center', 'none', '5900617037152'),
