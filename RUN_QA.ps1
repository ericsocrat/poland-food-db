...
.DESCRIPTION
    Executes:
       ...
       31. QA__scoring_determinism.sql (21 scoring determinism checks — blocking)
...
$suiteCatalog = @(
    ...
    @{ Num = 31; Name = "Scoring Determinism"; Short = "Determinism"; Id = "scoring_determinism"; Checks = 21; Blocking = $true; Kind = "sql"; File = "QA__scoring_determinism.sql" },
