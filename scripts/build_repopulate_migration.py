...
TAG_MAP: dict[str, str] = {
    ...
    "soja": "soybeans", "sojabohnen": "soybeans",
...
--
-- Rollback: DELETE FROM product_ingredient; DELETE FROM product_allergen_info WHERE tag IN (SELECT allergen_id FROM allergen_ref);
