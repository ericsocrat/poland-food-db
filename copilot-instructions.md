...
> **Ingredient analytics:** 1,257 unique ingredients, 728 allergen declarations, 782 trace declarations
...
├── supabase/
│   ├── config.toml
│   └── migrations/                  # 26 append-only schema migrations
...
| `ingredient_ref`     | Canonical ingredient dictionary           | `ingredient_id` (identity)              | 1,257 unique ingredients; taxonomy_id (OFF), vegan/vegetarian/palm_oil/is_additive flags   |
