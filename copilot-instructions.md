...
> **QA:** 89 critical checks + 8 informational reports — all passing
...
├── RUN_QA.ps1                       # QA test runner (89 critical + 8 info)
...
**Run:** `.\RUN_QA.ps1` — expects **89/89 critical checks passing**.
