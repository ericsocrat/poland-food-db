...
alcohol_eans = [
    ...
    (
        "Lech",
        "Lech Free 0,0% - piwo bezalkoholowe o smaku granatu i acai",
        "5901359084954",
    ),
...
if invalid_eans:
    ...
    print(
        f'Ready to apply with: docker exec supabase_db_poland-food-db psql -U postgres -d postgres -c "... migration SQL ..."'
    )
